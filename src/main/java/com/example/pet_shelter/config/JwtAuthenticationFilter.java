...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        jwt = authHeader.substring(7); // Убираем "Bearer " из токена
        userEmail = jwtConfig.extractUsername(jwt); // Извлекаем email из токена
        ...
        if (userEmail != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            if (jwtConfig.isTokenValid(jwt, userDetails)) {
                // Создаём объект аутентификации и устанавливаем его в SecurityContext
