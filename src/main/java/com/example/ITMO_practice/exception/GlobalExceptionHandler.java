...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorMessage> handleMissmatch(MethodArgumentTypeMismatchException ex) {
    ...
    public ResponseEntity<ErrorMessage> handleArgument(MethodArgumentNotValidException ex) {
